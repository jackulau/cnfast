...
Across 22 workloads the geometric mean is 2.61x. The bundle is 9.04 KB minified and gzipped, against 8.45 KB for `clsx` + `tailwind-merge`, because both ship the same Tailwind class-group data. See the [benchmark suite](./bench/README.md) for the full breakdown and how to reproduce it.
